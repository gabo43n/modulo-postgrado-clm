...
// IMPORTANTE sobre el orden: swaggerUi.setup(...) responde a CUALQUIER
// peticion GET dentro de su punto de montaje (no solo a "/"), asi que si
// registraramos la ruta ".../openapi.yaml" DESPUES del "app.use(...)" del
// swagger, esta nunca se alcanzaria — swaggerUi ya habria respondido con su
// propia pagina HTML antes de que Express llegara a esa ruta mas especifica.
// Por eso las 2 rutas que sirven el YAML crudo van ANTES de montar cada
// swagger (Express prueba las rutas en el orden en que se registran).
